...
function verifyProof(proof, hash) {
    ...
    (0, checkParameter_1.default)(proof.leafUsername, 'proof.leafUsername', 'bigint');
    ...
    var sum = proof.leafSum;
    var node = { hash: hash([proof.leafUsername, proof.leafSum]), sum: sum };
